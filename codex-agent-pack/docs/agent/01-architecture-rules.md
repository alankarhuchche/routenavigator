...
## Stack rules
Backend must be Java Quarkus. Frontend must be React TypeScript. Gemini integration must be wrapped behind a backend service. Initial data must be local JSON/YAML mock data.
