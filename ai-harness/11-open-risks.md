...
| Voice intent capture is demo-only | Medium | No | 3B/3B-fix | Browser speech recognition only populates/edits payment intent. It cannot approve or execute payment; passkey approval remains required before anything moves. |
